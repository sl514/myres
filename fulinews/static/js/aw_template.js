						...
						'<div class="modal-body">'+
							...
							'<form action="' + G_BASE_URL + '/question/ajax/save_answer_fox/" method="post" id="quick_publish" onsubmit="return false">'+
								...
								'<div class="aw-dropdown">'+
									...
									'</ul>'+
								'</div>'+
								'<textarea class="form-control" id="foxreply_message" name="message" rows="3" placeholder="' + _t('回复内容...') + '"></textarea>'+
							'</form>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<a data-dismiss="modal" aria-hidden="true" class="text-color-999">' + _t('取消') + '</a>'+
			...
			'<div class="modal fade alert-box aw-inbox">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('问题置顶') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							...
							'<h3 class="modal-title" id="myModalLabel"><img src="{{user_avatar}}" />对回答者[ {{user_name}} ]打赏</h3>'+
						'</div>'+
						'<div class="modal-body">'+
						'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
			...
			'<div class="modal fade alert-box aw-question-redirect-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
							'<h3 class="modal-title" id="myModalLabel"><img src="{{user_avatar}}" />对回答者[ {{user_name}} ]回答偷看打赏</h3>'+
						'</div>'+
						'<div class="modal-body">'+
						'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
						'<div class="modal-header qianbox_tem">'+
