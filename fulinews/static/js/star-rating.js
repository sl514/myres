...
function(e) {
    ...
    h.prototype = {
        ...
        _clearMouseMove: function(e) {
            ...
            n,
            r,
            i = this; ! i.hoverEnabled || i.inactive || !i.hoverOnClear || e && e.isDefaultPrevented() || (i.clearClicked = !1, t = '<span class="' + i.clearCaptionClass + '">' + i.clearCaption + "</span>", a = i.clearValue, n = i.getWidthFromValue(a) || 0, r = {
                caption: t,
                width: n,
                val: a
            },
        ...
        _renderCaption: function() {
            ...
            if (a.showCaption) {
                if (t = a.fetchCaption(n), r && r.length) return s(r, "caption"),
                r.html(t),
                void(a.$caption = r);
        ...
        _renderClear: function() {
            ...
            if (a.showClear) {
                if (t = a._getClearClass(), n.length) return s(n, t),
                n.attr({
    ...
    e.fn.rating = function(t) {
        ...
        switch (a.shift(), this.each(function() {
            ...
            u = {};
            s || ("en" === c || i(e.fn.ratingLocales[c]) || (u = e.fn.ratingLocales[c]), r = e.extend(!0, {},
            e.fn.rating.defaults, e.fn.ratingLocales.en, u, o, l.data()), s = new h(this, r), l.data("rating", s)),
